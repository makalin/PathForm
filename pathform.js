 ...
 */
function toJSON(pathformText, indent = 2) {
 ...
 */
function fromJSON(jsonObj, flat = false) {
...
`;
    ...
    console.log('Parsing PathForm...');
    const result = parsePathform(example);
    console.log('\nParsed JSON:');
    console.log(toJSON(example));
    
    console.log('\n\nRound-trip test:');
    const pathformAgain = fromJSON(result);
    console.log(pathformAgain);
}
